...
export const Nav = () => {
  ...
  return (
    <div className={`flex justify-center pb-2 pt-2.5 mt-8 mx-[58vh] fixed top-0 left-0 right-0 z-10 bg-opacity-95 ${scrolled ? 'bg-white py-3 px-7 rounded-[30px]' : ''}`}>
      <Link to="/" className={`px-6 text-[#4c6763] font-medium text-lg rounded-3xl pt-1.5 pb-1 font-serif ${isActive('/') ? 'bg-gray-100' : ''}`}>Work</Link>
      <Link to="/about" className={`px-6 text-[#4c6763] font-medium text-lg rounded-3xl pt-1.5 pb-1 font-serif ${isActive('/about') ? 'bg-gray-100' : ''}`}>About</Link>
