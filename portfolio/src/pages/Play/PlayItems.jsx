  ...
  return (
    <Link to={props.Link} target="_blank" 
        ...
        <div className='w-2/3' >
            ...
            <p className='text-[#4c6763] text-[14px] md:text-md font-semibold md:font-medium'>{props.ItemInfo}</p>
        </div>
        <div className='ml-4 mt-3 rounded-full bg-white w-[100px] h-[92px] md:w-[100px] md:h-[100px] overflow-hidden'>
            <img
